...
const PrivacyPolicy = () => {
    return (
        <div className="privacy-container">
            ...
            <p><strong>Last updated:</strong> March 13, 2025</p>
            <p>
            ...
            <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us", or "Our" in this
                    Agreement) refers to Kovalenko Lesia Ivanivna, 57 Rizdviana St., Apt. 27 Cherkasy 18005 Ukraine.
                </li>
            ...
            <h4>Usage Data</h4>
            <p>Usage Data is collected automatically when using the Service. Usage Data may include information such as
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
                ...
                browser. You can learn more about cookies on <a
                    ...
                    rel="noopener noreferrer">TermsFeed website</a> article.</p>
            ...
            <p>We will retain Your Personal Data only for as long as is necessary for the purposes set out in this
                ...
                legal obligations, resolve disputes, and enforce our legal agreements and policies.</p>
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us by email at: <a
